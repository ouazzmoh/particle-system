...
TEST(VecteurNormTest, HandlesZeroInput) {
...
TEST(VecteurNormTest, HandlesNormPositivity) {
    Vecteur v1 = Vecteur(7, 8, 4);
    Vecteur v2 = Vecteur(1, -4, 8);
...
TEST(VecteurOperators, HandlesPlusOperator) {
...
// On teste l'opérateur *
TEST(VecteurOperators, HandlesMultOperator) {
    Vecteur v1 = Vecteur(3.0, 2.0, 1.0);
    Vecteur v2 = Vecteur(2,1,1);
...
// On teste l'opérateur -
TEST(VecteurOperators, HandlesMinusOperator) {
    Vecteur v1 = Vecteur(3.0, 2.0, 1.0);
    Vecteur v2 = Vecteur(2,1,1);
...
// On teste l'opérateur ==
TEST(VecteurOperators, HandlesEqEqOperator) {
    Vecteur v1 = Vecteur(3.0, 2.0, 1.0);
    Vecteur v2 = Vecteur(3, 2, 1);
    EXPECT_TRUE(v1 == v2);
}
